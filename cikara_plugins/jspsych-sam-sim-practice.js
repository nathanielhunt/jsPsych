...
jsPsych.plugins.similarity_practice = (function() {

    var resp, mouse_listener_instructs, keyboard_listener, trial_data;
    var plugin = {};


    jsPsych.pluginAPI.registerPreload('similarity_practice', 'stimuli', 'image',function(t){ return !t.is_html || t.is_html == 'undefined'});
    jsPsych.pluginAPI.registerPreload('similarity_practice', 'peers', 'image',function(t){ return !t.is_html || t.is_html == 'undefined'});

    plugin.info = {
	name: 'similarity_practice',
	description: '',
	parameters: {
	    stimuli: {
