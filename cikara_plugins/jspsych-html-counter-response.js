...
jsPsych.plugins["html-counter-response"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-counter-response',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function after_response(choice) {
      ...
      display_element.querySelector('#jspsych-html-counter-response-stimulus').className += ' responded';

      // disable all the buttons after a response
      var btns = document.querySelectorAll('.jspsych-html-counter-response-button button');
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function() {
        display_element.querySelector('#jspsych-html-counter-response-stimulus').style.visibility = 'hidden';
